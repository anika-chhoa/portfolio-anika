...
//       // Included "experience" in sections tracker
//       const sections = ["hero", "about", "skills", "experience", "education", "projects", "services", "contact"];
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Section ID Tracker
      const sections = ["about", "skills", "experience", "education", "projects", "services", "contact"];
